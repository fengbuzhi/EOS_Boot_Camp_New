...
echo 'weicheng will sell their ticket called ticket1 for 6.0000 SYS'
echo 'zejia will sell their ticket called ticket2 for 6.0000 SYS'
...
echo 'cleos push action tradeticket sellticket ["weicheng","ticket1","6.0000 SYS"] -p ticket1'
cleos push action tradeticket sellticket '["weicheng","ticket1","6.0000 SYS","inseason"]' -p ticket1


echo 'cleos push action tradeticket sellticket ["zejia","ticket2","12.0000 SYS"] -p ticket2'
cleos push action tradeticket sellticket '["zejia","ticket2","12.0000 SYS","inseason"]' -p ticket2
